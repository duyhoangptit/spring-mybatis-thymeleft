...
public class ListPageImpl<T> extends ArrayList<T> implements ListPage<T> {
	 ...
	 *            considering the length of the content given, if it is going to be
	 *            the content of the last page. This is in place to mitigate
	 *            inconsistencies
	 */
	 ...
	 * 
	 * @see
	 * org.springframework.data.domain.Slice#transform(org.springframework.core.
